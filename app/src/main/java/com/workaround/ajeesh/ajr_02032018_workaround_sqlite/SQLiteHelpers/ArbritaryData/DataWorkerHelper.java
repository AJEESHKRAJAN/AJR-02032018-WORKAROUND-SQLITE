package com.workaround.ajeesh.ajr_02032018_workaround_sqlite.SQLiteHelpers.ArbritaryData;

import android.content.ContentValues;
import android.database.sqlite.SQLiteDatabase;

import com.workaround.ajeesh.ajr_02032018_workaround_sqlite.SQLiteHelpers.NoteKeeperDatabaseContract;

/**
 * Package Name : com.workaround.ajeesh.ajr_02032018_workaround_sqlite.SQLiteHelpers.ArbritaryData
 * Created by ajesh on 03-03-2018.
 * Project Name : AJR-02032018-WORKAROUND-SQLITE
 */

public class DataWorkerHelper {
    private SQLiteDatabase mDb;

    public DataWorkerHelper(SQLiteDatabase db) {
        mDb = db;
    }
